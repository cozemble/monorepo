...
test('can format a date with time as ISO 8601 string', () => {
  expect(dates.toIso8601DateTimeString(new Date(2021, 0, 11, 9, 14))).toBe(
    '2021-01-11T09:14:00.000Z',
  )
})
...
test('can parse an ISO 8601 string', () => {
  ...
  expect(dates.fromIso8601String('2021-11-01T09:14:00.000Z')).toMatchObject(
    new Date(2021, 10, 1, 9, 14),
  )
})
