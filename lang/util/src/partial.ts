...
function _1_of_4<A, B, C, D, R>(theA: A, f: (a: A, b: B, c: C, d: D) => R): (b: B, c: C, d: D) => R {
...
function _1_of_5<A, B, C, D, E, R>(theA: A, f: (a: A, b: B, c: C, d: D, e: E) => R): (b: B, c: C, d: D, e: E) => R {
...
function _1_of_6<A, B, C, D, E, F, R>(theA: A, func: (a: A, b: B, c: C, d: D, e: E, f: F) => R): (b: B, c: C, d: D, e: E, f: F) => R {
...
function _1_of_7<A, B, C, D, E, F, G, R>(theA: A, func: (a: A, b: B, c: C, d: D, e: E, f: F, g: G) => R): (b: B, c: C, d: D, e: E, f: F, g: G) => R {
...
function _1_of_8<A, B, C, D, E, F, G, H, R>(theA: A, func: (a: A, b: B, c: C, d: D, e: E, f: F, g: G, h: H) => R): (b: B, c: C, d: D, e: E, f: F, g: G, h: H) => R {
...
function _2_of_4<A, B, C, D, R>(theA: A, theB: B, f: (a: A, b: B, c: C, d: D) => R): (c: C, d: D) => R {
