...
import {bestGuessAtMessageForUser, ErrorWithContext, mergeContext, mergeErrorContext, prependToMessage} from "./errors";
...
export type IdLabelSelectedAndValue<T = any> = { id: string, label: string, selected: boolean, value: T }
...
export function idLabelSelectedAndValue<T = any>(id: string, label: string, selected: boolean, value: T): IdLabelSelectedAndValue<T> {
...
export function nameValueAndType<V = any, T = string>(name: string, value: V, type: T): NameValueAndType<V, T> {
