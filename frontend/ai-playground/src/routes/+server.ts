...
import { idRemovingOpenAi, mandatoryOpenAiCreds, OpenAi } from '$lib/generative/GenerativeAiBackend'
...
export const POST: RequestHandler = async (event: RequestEvent) => {
  ...
  try {
    const openAi = idRemovingOpenAi(new OpenAi(mandatoryOpenAiCreds(), promptEventSender))
