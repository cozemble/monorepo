...
<div class=" flex flex-col gap-3">
  ...
  <button class="btn bg-gray-700 hover:bg-black text-base-100 w-full" on:click={() => handleOAuthLogin('github')}>
  ...
  <button class="btn bg-[#0072b1] hover:bg-[#07537c] text-base-100 w-full" on:click={() => handleOAuthLogin('linkedin')}>
